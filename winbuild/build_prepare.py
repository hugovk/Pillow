...
deps = {
    "libjpeg": {
        "url": SF_MIRROR
        + "/project/libjpeg-turbo/2.1.3/libjpeg-turbo-2.1.3.tar.gz/download",
    ...
    "libpng": {
        "url": SF_MIRROR + "/project/libpng/libpng16/1.6.37/lpng1637.zip/download",
    ...
    "lcms2": {
        "url": SF_MIRROR + "/project/lcms/lcms/2.13/lcms2-2.13.1.tar.gz/download",
