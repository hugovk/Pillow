...
static OutlineObject* _outline_new(void) {
    OutlineObject* self;

    if (PyType_Ready(&OutlineType) < 0) return NULL;
...
static void _outline_dealloc(OutlineObject* self) {
    ImagingOutlineDelete(self->outline);
    PyObject_Del(self);
}

ImagingOutline PyOutline_AsOutline(PyObject* outline) {
    if (PyOutline_Check(outline)) return ((OutlineObject*)outline)->outline;
...
PyObject* PyOutline_Create(PyObject* self, PyObject* args) {
    if (!PyArg_ParseTuple(args, ":outline")) return NULL;
...
static PyObject* _outline_move(OutlineObject* self, PyObject* args) {
    float x0, y0;
    if (!PyArg_ParseTuple(args, "ff", &x0, &y0)) return NULL;
...
static PyObject* _outline_line(OutlineObject* self, PyObject* args) {
    float x1, y1;
    if (!PyArg_ParseTuple(args, "ff", &x1, &y1)) return NULL;
...
static PyObject* _outline_curve(OutlineObject* self, PyObject* args) {
...
static PyObject* _outline_close(OutlineObject* self, PyObject* args) {
...
static PyObject* _outline_transform(OutlineObject* self, PyObject* args) {
    double a[6];
