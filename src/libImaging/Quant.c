...
static int unshifted_pixel_cmp(const HashTable* h,
                               const Pixel pixel1,
                               const Pixel pixel2) {
...
static int pixel_cmp(const HashTable* h,
                     const Pixel pixel1,
                     const Pixel pixel2) {
    PixelHashData* d = (PixelHashData*)hashtable_get_user_data(h);
    uint32_t A, B;
...
static void exists_count_func(const HashTable* h,
                              const Pixel key,
                              uint32_t* val) {
    *val += 1;
}
...
static void rehash_collide(const HashTable* h,
                           Pixel* keyp,
                           uint32_t* valp,
                           Pixel newkey,
                           uint32_t newval) {
...
static void hash_to_list(const HashTable* h,
                         const Pixel pixel,
...
static int splitlists(PixelList* h[3],
                      PixelList* t[3],
                      PixelList* nh[2][3],
                      PixelList* nt[2][3],
                      uint32_t nCount[2],
...
static BoxNode* median_cut(PixelList* hl[3],
...
static int resort_distance_tables(uint32_t* avgDist,
...
static int build_distance_tables(uint32_t* avgDist,
                                 uint32_t** avgDistSortKey,
                                 Pixel* p,
                                 uint32_t nEntries) {
    uint32_t i, j;
...
static int map_image_pixels(Pixel* pixelData,
                            uint32_t nPixels,
                            Pixel* paletteData,
...
static int map_image_pixels_from_quantized_pixels(Pixel* pixelData,
                                                  uint32_t nPixels,
                                                  Pixel* paletteData,
                                                  uint32_t nPaletteEntries,
                                                  uint32_t* avgDist,
...
static int map_image_pixels_from_median_box(Pixel* pixelData,
                                            uint32_t nPixels,
                                            Pixel* paletteData,
                                            uint32_t nPaletteEntries,
...
static int compute_palette_from_median_cut(Pixel* pixelData,
                                           uint32_t nPixels,
                                           HashTable* medianBoxHash,
                                           Pixel** palette,
                                           uint32_t nPaletteEntries) {
...
static int compute_palette_from_quantized_pixels(Pixel* pixelData,
                                                 uint32_t nPixels,
                                                 Pixel* palette,
                                                 uint32_t nPaletteEntries,
                                                 uint32_t* avg[3],
...
static int k_means(Pixel* pixelData,
                   uint32_t nPixels,
                   Pixel* paletteData,
                   uint32_t nPaletteEntries,
                   uint32_t* qp,
...
static void compute_distances(const HashTable* h,
                              const Pixel pixel,
                              uint32_t* dist,
                              void* u) {
