...
#define IMAGING_MODE_LENGTH                                                    \
    ...
    struct ImagingMemoryInstance
    {
        ...
        /* Format */
        char mode[IMAGING_MODE_LENGTH]; /* Band names ("1", "L", "P", "RGB",
                                           "RGBA", "CMYK", "YCbCr", "BGR;xy") */
...
#define IMAGING_PIXEL_FLOAT32(im, x, y) (((FLOAT32*)(im)->image32[y])[x])
    ...
    struct ImagingHistogramInstance
    {
        ...
        /* Format */
        char mode[IMAGING_MODE_LENGTH]; /* Band names (of corresponding source
                                           image) */
    ...
    typedef struct ImagingMemoryArena
    {
        ...
        int blocks_cached; /* Current number of blocks not associated with
                              images */
        ...
        int stats_reused_blocks; /* Number of blocks which were retrieved from a
                                    pool */
    ...
    extern int ImagingMemorySetBlocksMax(ImagingMemoryArena arena,
                                         int blocks_max);
...
#define ImagingPaletteCache(p, r, g, b)                                        \
    ...
    extern Imaging ImagingQuantize(Imaging im,
                                   int colours,
                                   int mode,
                                   int kmeans);
    ...
    extern void* ImagingError_ModeError(
        void); /* maps to ValueError by default */
    extern void* ImagingError_Mismatch(
        void); /* maps to ValueError by default */
...
#define IMAGING_TRANSFORM_LANCZOS 1
    ...
    typedef int (
        *ImagingTransformMap)(double* X, double* Y, int x, int y, void* data);
    typedef int (*ImagingTransformFilter)(void* out,
                                          Imaging im,
                                          double x,
                                          double y);
    ...
    extern Imaging ImagingConvert(Imaging im,
                                  const char* mode,
                                  ImagingPalette palette,
                                  int dither);
    extern Imaging ImagingConvertInPlace(Imaging im, const char* mode);
    extern Imaging ImagingConvertMatrix(Imaging im,
                                        const char* mode,
                                        float m[]);
    extern Imaging ImagingConvertTransparent(Imaging im,
                                             const char* mode,
                                             int r,
                                             int g,
                                             int b);
    ...
    extern int ImagingFill2(Imaging into,
                            const void* ink,
                            Imaging mask,
                            int x0,
                            int y0,
    ...
    extern Imaging ImagingFilter(Imaging im,
                                 int xsize,
                                 int ysize,
                                 const FLOAT32* kernel,
                                 FLOAT32 offset);
    ...
    extern Imaging ImagingGaussianBlur(Imaging imOut,
                                       Imaging imIn,
                                       float radius,
                                       int passes);
    ...
    extern int ImagingPaste(Imaging into,
                            Imaging im,
                            Imaging mask,
                            int x0,
                            int y0,
                            int x1,
                            int y1);
    extern Imaging ImagingPoint(Imaging im,
                                const char* tablemode,
                                const void* table);
    extern Imaging ImagingPointTransform(Imaging imIn,
                                         double scale,
                                         double offset);
    ...
    extern Imaging ImagingResample(Imaging imIn,
                                   int xsize,
                                   int ysize,
                                   int filter,
                                   float box[4]);
    extern Imaging ImagingReduce(Imaging imIn,
                                 int xscale,
                                 int yscale,
                                 int box[4]);
    extern Imaging ImagingTransform(Imaging imOut,
                                    Imaging imIn,
                                    int method,
                                    int x0,
                                    int y0,
                                    ...
                                    int filter,
                                    int fill);
    extern Imaging ImagingUnsharpMask(Imaging imOut,
                                      Imaging im,
                                      float radius,
                                      int percent,
                                      int threshold);
    extern Imaging ImagingBoxBlur(Imaging imOut,
                                  Imaging imIn,
                                  float radius,
                                  int n);
    extern Imaging ImagingColorLUT3D_linear(Imaging imOut,
                                            Imaging imIn,
                                            int table_channels,
                                            int size1D,
                                            int size2D,
    ...
    extern Imaging ImagingChopAdd(Imaging imIn1,
                                  Imaging imIn2,
                                  float scale,
                                  int offset);
    extern Imaging ImagingChopSubtract(Imaging imIn1,
                                       Imaging imIn2,
                                       float scale,
                                       int offset);
    ...
    /* Graphics */
    extern int ImagingDrawArc(Imaging im,
                              int x0,
                              int y0,
                              int x1,
                              int y1,
                              ...
                              int width,
                              int op);
    extern int ImagingDrawBitmap(Imaging im,
                                 int x0,
                                 int y0,
                                 Imaging bitmap,
                                 const void* ink,
                                 int op);
    extern int ImagingDrawChord(Imaging im,
                                int x0,
                                int y0,
                                int x1,
                                int y1,
                                ...
                                int width,
                                int op);
    extern int ImagingDrawEllipse(Imaging im,
                                  int x0,
                                  int y0,
                                  int x1,
                                  int y1,
                                  ...
                                  int width,
                                  int op);
    extern int ImagingDrawLine(Imaging im,
                               int x0,
                               int y0,
                               int x1,
                               int y1,
                               const void* ink,
                               int op);
    extern int ImagingDrawWideLine(Imaging im,
                                   int x0,
                                   int y0,
                                   int x1,
                                   int y1,
                                   ...
                                   int width,
                                   int op);
    extern int ImagingDrawPieslice(Imaging im,
                                   int x0,
                                   int y0,
                                   int x1,
                                   int y1,
                                   ...
                                   int width,
                                   int op);
    extern int ImagingDrawPoint(Imaging im,
                                int x,
                                int y,
                                const void* ink,
                                int op);
    extern int ImagingDrawPolygon(Imaging im,
                                  int points,
                                  int* xy,
                                  const void* ink,
                                  int fill,
                                  int op);
    extern int ImagingDrawRectangle(Imaging im,
                                    int x0,
                                    int y0,
                                    int x1,
                                    int y1,
    ...
    extern int ImagingDrawOutline(Imaging im,
    ...
    extern int ImagingOutlineCurve(ImagingOutline outline,
                                   float x1,
                                   float y1,
                                   float x2,
                                   float y2,
    ...
    extern Imaging ImagingEffectMandelbrot(int xsize,
                                           int ysize,
                                           double extent[4],
                                           int quality);
    ...
    typedef int (*ImagingCodec)(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);

    extern int ImagingBcnDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingBitDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingEpsEncode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);
    extern int ImagingFliDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingGifDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingGifEncode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);
    extern int ImagingHexDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
#ifdef HAVE_LIBJPEG
    extern int ImagingJpegDecode(Imaging im,
                                 ImagingCodecState state,
                                 UINT8* buffer,
                                 Py_ssize_t bytes);
    ...
    extern int ImagingJpegEncode(Imaging im,
                                 ImagingCodecState state,
                                 UINT8* buffer,
                                 int bytes);
#endif
#ifdef HAVE_OPENJPEG
    extern int ImagingJpeg2KDecode(Imaging im,
                                   ImagingCodecState state,
                                   UINT8* buffer,
                                   Py_ssize_t bytes);
    extern int ImagingJpeg2KDecodeCleanup(ImagingCodecState state);
    extern int ImagingJpeg2KEncode(Imaging im,
                                   ImagingCodecState state,
                                   UINT8* buffer,
                                   int bytes);
...
#endif
#ifdef HAVE_LIBTIFF
    extern int ImagingLibTiffDecode(Imaging im,
                                    ImagingCodecState state,
                                    UINT8* buffer,
                                    Py_ssize_t bytes);
    extern int ImagingLibTiffEncode(Imaging im,
                                    ImagingCodecState state,
                                    UINT8* buffer,
                                    int bytes);
#endif
#ifdef HAVE_LIBMPEG
    extern int ImagingMpegDecode(Imaging im,
                                 ImagingCodecState state,
                                 UINT8* buffer,
                                 Py_ssize_t bytes);
#endif
    extern int ImagingMspDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingPackbitsDecode(Imaging im,
                                     ImagingCodecState state,
                                     UINT8* buffer,
                                     Py_ssize_t bytes);
    extern int ImagingPcdDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingPcxDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingPcxEncode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);
    extern int ImagingRawDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingRawEncode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);
    extern int ImagingSgiRleDecode(Imaging im,
                                   ImagingCodecState state,
                                   UINT8* buffer,
                                   Py_ssize_t bytes);
    extern int ImagingSgiRleDecodeCleanup(ImagingCodecState state);
    extern int ImagingSunRleDecode(Imaging im,
                                   ImagingCodecState state,
                                   UINT8* buffer,
                                   Py_ssize_t bytes);
    extern int ImagingTgaRleDecode(Imaging im,
                                   ImagingCodecState state,
                                   UINT8* buffer,
                                   Py_ssize_t bytes);
    extern int ImagingTgaRleEncode(Imaging im,
                                   ImagingCodecState state,
                                   UINT8* buffer,
                                   int bytes);
    extern int ImagingXbmDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingXbmEncode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);
#ifdef HAVE_LIBZ
    extern int ImagingZipDecode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                Py_ssize_t bytes);
    extern int ImagingZipDecodeCleanup(ImagingCodecState state);
    extern int ImagingZipEncode(Imaging im,
                                ImagingCodecState state,
                                UINT8* buffer,
                                int bytes);
    ...
    extern void ImagingConvertRGB2YCbCr(UINT8* out,
                                        const UINT8* in,
                                        int pixels);
    extern void ImagingConvertYCbCr2RGB(UINT8* out,
                                        const UINT8* in,
                                        int pixels);
    ...
    extern Py_ssize_t _imaging_read_pyFd(PyObject* fd,
                                         char* dest,
                                         Py_ssize_t bytes);
    extern Py_ssize_t _imaging_write_pyFd(PyObject* fd,
                                          char* src,
                                          Py_ssize_t bytes);
