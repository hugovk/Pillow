...
Imaging ImagingEffectMandelbrot(int xsize, int ysize, double extent[4],
                                int quality) {
...
Imaging ImagingEffectNoise(int xsize, int ysize, float sigma) {
...
Imaging ImagingEffectSpread(Imaging imIn, int distance) {
