...
static inline void paste(Imaging imOut,
                         Imaging imIn,
                         int dx,
                         int dy,
                         int sx,
...
static inline void paste_mask_1(Imaging imOut,
                                Imaging imIn,
                                Imaging imMask,
                                int dx,
                                int dy,
...
static inline void paste_mask_L(Imaging imOut,
                                Imaging imIn,
                                Imaging imMask,
                                int dx,
                                int dy,
...
static inline void paste_mask_RGBA(Imaging imOut,
                                   Imaging imIn,
                                   Imaging imMask,
                                   int dx,
                                   int dy,
...
int ImagingPaste(Imaging imOut,
                 Imaging imIn,
                 Imaging imMask,
                 int dx0,
                 int dy0,
...
static inline void fill(Imaging imOut,
                        const void* ink_,
                        int dx,
                        int dy,
                        int xsize,
...
static inline void fill_mask_1(Imaging imOut,
                               const void* ink_,
                               Imaging imMask,
                               int dx,
                               int dy,
...
static inline void fill_mask_L(Imaging imOut,
                               const UINT8* ink,
                               Imaging imMask,
                               int dx,
                               int dy,
...
static inline void fill_mask_RGBA(Imaging imOut,
                                  const UINT8* ink,
                                  Imaging imMask,
                                  int dx,
                                  int dy,
...
int ImagingFill2(Imaging imOut,
                 const void* ink,
                 Imaging imMask,
                 int dx0,
                 int dy0,
