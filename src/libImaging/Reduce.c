...
void ImagingReduceNxN(Imaging imOut, Imaging imIn, int box[4], int xscale, int yscale)
{
            ...
            for (x = 0; x < box[2] / xscale; x++) {
                ...
                for (yy = yy_from; yy < yy_from + yscale - 1; yy += 2) {
                    ...
                    for (xx = xx_from; xx < xx_from + xscale - 1; xx += 2) {
                        ss += line0[xx + 0] + line0[xx + 1] + line1[xx + 0] + line1[xx + 1];
                    }
                    if (xscale & 0x01) {
...
void ImagingReduce1xN(Imaging imOut, Imaging imIn, int box[4], int yscale)
{
...
void ImagingReduceNx1(Imaging imOut, Imaging imIn, int box[4], int xscale)
{
...
void ImagingReduce1x2(Imaging imOut, Imaging imIn, int box[4])
{
...
void ImagingReduce2x1(Imaging imOut, Imaging imIn, int box[4])
{
...
void ImagingReduce2x2(Imaging imOut, Imaging imIn, int box[4])
{
...
void ImagingReduce1x3(Imaging imOut, Imaging imIn, int box[4])
{
...
void ImagingReduce3x1(Imaging imOut, Imaging imIn, int box[4])
{
...
void ImagingReduce3x3(Imaging imOut, Imaging imIn, int box[4])
{
    ...
    */
    ...
    if (imIn->image8) {
        for (y = 0; y < box[3] / yscale; y++) {
            ...
            for (x = 0; x < box[2] / xscale; x++) {
                int xx = box[0] + x * xscale;
                ss0 = line0[xx + 0] + line0[xx + 1] + line0[xx + 2] + line1[xx + 0] + line1[xx + 1] + line1[xx + 2] + line2[xx + 0] + line2[xx + 1] + line2[xx + 2];
                imOut->image8[y][x] = ((ss0 + amend) * multiplier) >> 24;
            }
        }
    } else {
        for (y = 0; y < box[3] / yscale; y++) {
            ...
            if (imIn->bands == 2) {
                for (x = 0; x < box[2] / xscale; x++) {
                    int xx = box[0] + x * xscale;
                    UINT32 v;
                    ss0 = line0[xx * 4 + 0] + line0[xx * 4 + 4] + line0[xx * 4 + 8] + line1[xx * 4 + 0] + line1[xx * 4 + 4] + line1[xx * 4 + 8] + line2[xx * 4 + 0] + line2[xx * 4 + 4] + line2[xx * 4 + 8];
                    ss3 = line0[xx * 4 + 3] + line0[xx * 4 + 7] + line0[xx * 4 + 11] + line1[xx * 4 + 3] + line1[xx * 4 + 7] + line1[xx * 4 + 11] + line2[xx * 4 + 3] + line2[xx * 4 + 7] + line2[xx * 4 + 11];
                    v = MAKE_UINT32(
                        ((ss0 + amend) * multiplier) >> 24, 0,
                        0, ((ss3 + amend) * multiplier) >> 24);
                    memcpy(imOut->image[y] + x * sizeof(v), &v, sizeof(v));
                ...
                for (x = 0; x < box[2] / xscale; x++) {
                    ...
                    UINT32 v;
                    ss0 = line0[xx * 4 + 0] + line0[xx * 4 + 4] + line0[xx * 4 + 8] + line1[xx * 4 + 0] + line1[xx * 4 + 4] + line1[xx * 4 + 8] + line2[xx * 4 + 0] + line2[xx * 4 + 4] + line2[xx * 4 + 8];
                    ss1 = line0[xx * 4 + 1] + line0[xx * 4 + 5] + line0[xx * 4 + 9] + line1[xx * 4 + 1] + line1[xx * 4 + 5] + line1[xx * 4 + 9] + line2[xx * 4 + 1] + line2[xx * 4 + 5] + line2[xx * 4 + 9];
                    ss2 = line0[xx * 4 + 2] + line0[xx * 4 + 6] + line0[xx * 4 + 10] + line1[xx * 4 + 2] + line1[xx * 4 + 6] + line1[xx * 4 + 10] + line2[xx * 4 + 2] + line2[xx * 4 + 6] + line2[xx * 4 + 10];
                    v = MAKE_UINT32(
                        ((ss0 + amend) * multiplier) >> 24, ((ss1 + amend) * multiplier) >> 24,
                        ((ss2 + amend) * multiplier) >> 24, 0);
                    memcpy(imOut->image[y] + x * sizeof(v), &v, sizeof(v));
...
void ImagingReduce4x4(Imaging imOut, Imaging imIn, int box[4])
{
    ...
    */
    ...
    if (imIn->image8) {
        for (y = 0; y < box[3] / yscale; y++) {
            ...
            for (x = 0; x < box[2] / xscale; x++) {
                int xx = box[0] + x * xscale;
                ss0 = line0[xx + 0] + line0[xx + 1] + line0[xx + 2] + line0[xx + 3] + line1[xx + 0] + line1[xx + 1] + line1[xx + 2] + line1[xx + 3] + line2[xx + 0] + line2[xx + 1] + line2[xx + 2] + line2[xx + 3] + line3[xx + 0] + line3[xx + 1] + line3[xx + 2] + line3[xx + 3];
        ...
        for (y = 0; y < box[3] / yscale; y++) {
            ...
            if (imIn->bands == 2) {
                for (x = 0; x < box[2] / xscale; x++) {
                    int xx = box[0] + x * xscale;
                    UINT32 v;
                    ss0 = line0[xx * 4 + 0] + line0[xx * 4 + 4] + line0[xx * 4 + 8] + line0[xx * 4 + 12] + line1[xx * 4 + 0] + line1[xx * 4 + 4] + line1[xx * 4 + 8] + line1[xx * 4 + 12] + line2[xx * 4 + 0] + line2[xx * 4 + 4] + line2[xx * 4 + 8] + line2[xx * 4 + 12] + line3[xx * 4 + 0] + line3[xx * 4 + 4] + line3[xx * 4 + 8] + line3[xx * 4 + 12];
                    ss3 = line0[xx * 4 + 3] + line0[xx * 4 + 7] + line0[xx * 4 + 11] + line0[xx * 4 + 15] + line1[xx * 4 + 3] + line1[xx * 4 + 7] + line1[xx * 4 + 11] + line1[xx * 4 + 15] + line2[xx * 4 + 3] + line2[xx * 4 + 7] + line2[xx * 4 + 11] + line2[xx * 4 + 15] + line3[xx * 4 + 3] + line3[xx * 4 + 7] + line3[xx * 4 + 11] + line3[xx * 4 + 15];
                ...
                for (x = 0; x < box[2] / xscale; x++) {
                    ...
                    UINT32 v;
                    ss0 = line0[xx * 4 + 0] + line0[xx * 4 + 4] + line0[xx * 4 + 8] + line0[xx * 4 + 12] + line1[xx * 4 + 0] + line1[xx * 4 + 4] + line1[xx * 4 + 8] + line1[xx * 4 + 12] + line2[xx * 4 + 0] + line2[xx * 4 + 4] + line2[xx * 4 + 8] + line2[xx * 4 + 12] + line3[xx * 4 + 0] + line3[xx * 4 + 4] + line3[xx * 4 + 8] + line3[xx * 4 + 12];
                    ss1 = line0[xx * 4 + 1] + line0[xx * 4 + 5] + line0[xx * 4 + 9] + line0[xx * 4 + 13] + line1[xx * 4 + 1] + line1[xx * 4 + 5] + line1[xx * 4 + 9] + line1[xx * 4 + 13] + line2[xx * 4 + 1] + line2[xx * 4 + 5] + line2[xx * 4 + 9] + line2[xx * 4 + 13] + line3[xx * 4 + 1] + line3[xx * 4 + 5] + line3[xx * 4 + 9] + line3[xx * 4 + 13];
                    ss2 = line0[xx * 4 + 2] + line0[xx * 4 + 6] + line0[xx * 4 + 10] + line0[xx * 4 + 14] + line1[xx * 4 + 2] + line1[xx * 4 + 6] + line1[xx * 4 + 10] + line1[xx * 4 + 14] + line2[xx * 4 + 2] + line2[xx * 4 + 6] + line2[xx * 4 + 10] + line2[xx * 4 + 14] + line3[xx * 4 + 2] + line3[xx * 4 + 6] + line3[xx * 4 + 10] + line3[xx * 4 + 14];
...
void ImagingReduce5x5(Imaging imOut, Imaging imIn, int box[4])
{
    ...
    */
    ...
    if (imIn->image8) {
        for (y = 0; y < box[3] / yscale; y++) {
            ...
            for (x = 0; x < box[2] / xscale; x++) {
                int xx = box[0] + x * xscale;
                ss0 = line0[xx + 0] + line0[xx + 1] + line0[xx + 2] + line0[xx + 3] + line0[xx + 4] + line1[xx + 0] + line1[xx + 1] + line1[xx + 2] + line1[xx + 3] + line1[xx + 4] + line2[xx + 0] + line2[xx + 1] + line2[xx + 2] + line2[xx + 3] + line2[xx + 4] + line3[xx + 0] + line3[xx + 1] + line3[xx + 2] + line3[xx + 3] + line3[xx + 4] + line4[xx + 0] + line4[xx + 1] + line4[xx + 2] + line4[xx + 3] + line4[xx + 4];
                imOut->image8[y][x] = ((ss0 + amend) * multiplier) >> 24;
            }
        }
    } else {
        for (y = 0; y < box[3] / yscale; y++) {
            ...
            if (imIn->bands == 2) {
                for (x = 0; x < box[2] / xscale; x++) {
                    int xx = box[0] + x * xscale;
                    UINT32 v;
                    ss0 = line0[xx * 4 + 0] + line0[xx * 4 + 4] + line0[xx * 4 + 8] + line0[xx * 4 + 12] + line0[xx * 4 + 16] + line1[xx * 4 + 0] + line1[xx * 4 + 4] + line1[xx * 4 + 8] + line1[xx * 4 + 12] + line1[xx * 4 + 16] + line2[xx * 4 + 0] + line2[xx * 4 + 4] + line2[xx * 4 + 8] + line2[xx * 4 + 12] + line2[xx * 4 + 16] + line3[xx * 4 + 0] + line3[xx * 4 + 4] + line3[xx * 4 + 8] + line3[xx * 4 + 12] + line3[xx * 4 + 16] + line4[xx * 4 + 0] + line4[xx * 4 + 4] + line4[xx * 4 + 8] + line4[xx * 4 + 12] + line4[xx * 4 + 16];
                    ss3 = line0[xx * 4 + 3] + line0[xx * 4 + 7] + line0[xx * 4 + 11] + line0[xx * 4 + 15] + line0[xx * 4 + 19] + line1[xx * 4 + 3] + line1[xx * 4 + 7] + line1[xx * 4 + 11] + line1[xx * 4 + 15] + line1[xx * 4 + 19] + line2[xx * 4 + 3] + line2[xx * 4 + 7] + line2[xx * 4 + 11] + line2[xx * 4 + 15] + line2[xx * 4 + 19] + line3[xx * 4 + 3] + line3[xx * 4 + 7] + line3[xx * 4 + 11] + line3[xx * 4 + 15] + line3[xx * 4 + 19] + line4[xx * 4 + 3] + line4[xx * 4 + 7] + line4[xx * 4 + 11] + line4[xx * 4 + 15] + line4[xx * 4 + 19];
                    v = MAKE_UINT32(
                        ((ss0 + amend) * multiplier) >> 24, 0,
                        0, ((ss3 + amend) * multiplier) >> 24);
                    memcpy(imOut->image[y] + x * sizeof(v), &v, sizeof(v));
                ...
                for (x = 0; x < box[2] / xscale; x++) {
                    ...
                    UINT32 v;
                    ss0 = line0[xx * 4 + 0] + line0[xx * 4 + 4] + line0[xx * 4 + 8] + line0[xx * 4 + 12] + line0[xx * 4 + 16] + line1[xx * 4 + 0] + line1[xx * 4 + 4] + line1[xx * 4 + 8] + line1[xx * 4 + 12] + line1[xx * 4 + 16] + line2[xx * 4 + 0] + line2[xx * 4 + 4] + line2[xx * 4 + 8] + line2[xx * 4 + 12] + line2[xx * 4 + 16] + line3[xx * 4 + 0] + line3[xx * 4 + 4] + line3[xx * 4 + 8] + line3[xx * 4 + 12] + line3[xx * 4 + 16] + line4[xx * 4 + 0] + line4[xx * 4 + 4] + line4[xx * 4 + 8] + line4[xx * 4 + 12] + line4[xx * 4 + 16];
                    ss1 = line0[xx * 4 + 1] + line0[xx * 4 + 5] + line0[xx * 4 + 9] + line0[xx * 4 + 13] + line0[xx * 4 + 17] + line1[xx * 4 + 1] + line1[xx * 4 + 5] + line1[xx * 4 + 9] + line1[xx * 4 + 13] + line1[xx * 4 + 17] + line2[xx * 4 + 1] + line2[xx * 4 + 5] + line2[xx * 4 + 9] + line2[xx * 4 + 13] + line2[xx * 4 + 17] + line3[xx * 4 + 1] + line3[xx * 4 + 5] + line3[xx * 4 + 9] + line3[xx * 4 + 13] + line3[xx * 4 + 17] + line4[xx * 4 + 1] + line4[xx * 4 + 5] + line4[xx * 4 + 9] + line4[xx * 4 + 13] + line4[xx * 4 + 17];
                    ss2 = line0[xx * 4 + 2] + line0[xx * 4 + 6] + line0[xx * 4 + 10] + line0[xx * 4 + 14] + line0[xx * 4 + 18] + line1[xx * 4 + 2] + line1[xx * 4 + 6] + line1[xx * 4 + 10] + line1[xx * 4 + 14] + line1[xx * 4 + 18] + line2[xx * 4 + 2] + line2[xx * 4 + 6] + line2[xx * 4 + 10] + line2[xx * 4 + 14] + line2[xx * 4 + 18] + line3[xx * 4 + 2] + line3[xx * 4 + 6] + line3[xx * 4 + 10] + line3[xx * 4 + 14] + line3[xx * 4 + 18] + line4[xx * 4 + 2] + line4[xx * 4 + 6] + line4[xx * 4 + 10] + line4[xx * 4 + 14] + line4[xx * 4 + 18];
                    v = MAKE_UINT32(
                        ((ss0 + amend) * multiplier) >> 24, ((ss1 + amend) * multiplier) >> 24,
                        ((ss2 + amend) * multiplier) >> 24, 0);
                    memcpy(imOut->image[y] + x * sizeof(v), &v, sizeof(v));
...
void ImagingReduceCorners(Imaging imOut, Imaging imIn, int box[4], int xscale, int yscale)
{
...
void ImagingReduceNxN_32bpc(Imaging imOut, Imaging imIn, int box[4], int xscale, int yscale)
{
    /* The most general implementation for any xscale and yscale
    */
    int x, y, xx, yy;
...
void ImagingReduceCorners_32bpc(Imaging imOut, Imaging imIn, int box[4], int xscale, int yscale)
{
    /* Fill the last row and the last column for any xscale and yscale.
    */
    int x, y, xx, yy;
