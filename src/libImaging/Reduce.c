...
void ImagingReduceNxN(Imaging imOut,
                      Imaging imIn,
                      int box[4],
                      int xscale,
                      int yscale) {
...
void ImagingReduceCorners(Imaging imOut,
                          Imaging imIn,
                          int box[4],
                          int xscale,
                          int yscale) {
...
void ImagingReduceNxN_32bpc(Imaging imOut,
                            Imaging imIn,
                            int box[4],
                            int xscale,
                            int yscale) {
...
void ImagingReduceCorners_32bpc(Imaging imOut,
                                Imaging imIn,
                                int box[4],
                                int xscale,
                                int yscale) {
