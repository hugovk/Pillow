...
static void im_point_8_8(Imaging imOut,
                         Imaging imIn,
...
static void im_point_2x8_2x8(Imaging imOut,
                             Imaging imIn,
                             im_point_context* context) {
    int x, y;
...
static void im_point_3x8_3x8(Imaging imOut,
                             Imaging imIn,
                             im_point_context* context) {
    int x, y;
...
static void im_point_4x8_4x8(Imaging imOut,
                             Imaging imIn,
                             im_point_context* context) {
    int x, y;
...
static void im_point_8_32(Imaging imOut,
                          Imaging imIn,
                          im_point_context* context) {
    int x, y;
...
static void im_point_32_8(Imaging imOut,
                          Imaging imIn,
                          im_point_context* context) {
    int x, y;
