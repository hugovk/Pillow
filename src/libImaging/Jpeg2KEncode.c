...
static OPJ_SIZE_T j2k_write(void* p_buffer,
...
typedef void (*j2k_pack_tile_t)(Imaging im,
                                UINT8* buf,
                                unsigned x0,
                                unsigned y0,
                                unsigned w,
...
static void j2k_pack_l(Imaging im,
                       UINT8* buf,
                       unsigned x0,
                       unsigned y0,
                       unsigned w,
...
static void j2k_pack_i16(Imaging im,
                         UINT8* buf,
                         unsigned x0,
                         unsigned y0,
                         unsigned w,
...
static void j2k_pack_la(Imaging im,
                        UINT8* buf,
                        unsigned x0,
                        unsigned y0,
                        unsigned w,
...
static void j2k_pack_rgb(Imaging im,
                         UINT8* buf,
                         unsigned x0,
                         unsigned y0,
                         unsigned w,
...
static void j2k_pack_rgba(Imaging im,
                          UINT8* buf,
                          unsigned x0,
                          unsigned y0,
                          unsigned w,
...
static void j2k_set_cinema_params(Imaging im,
                                  int components,
...
int ImagingJpeg2KEncode(Imaging im,
