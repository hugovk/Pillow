...
static void put_block(Imaging im, ImagingCodecState state, const char *col,
                      int sz, int C) {
...
static int decode_bcn(Imaging im, ImagingCodecState state, const UINT8 *src,
                      int bytes, int N, int C) {
...
int ImagingBcnDecode(Imaging im, ImagingCodecState state, UINT8 *buf,
                     Py_ssize_t bytes) {
