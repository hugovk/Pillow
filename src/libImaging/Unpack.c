...
static void unpack1(UINT8* out, const UINT8* in, int pixels) {
...
static void unpack1I(UINT8* out, const UINT8* in, int pixels) {
...
static void unpack1R(UINT8* out, const UINT8* in, int pixels) {
...
static void unpack1IR(UINT8* out, const UINT8* in, int pixels) {
...
static void unpack18(UINT8* out, const UINT8* in, int pixels) {
...
static void unpackL2(UINT8* out, const UINT8* in, int pixels) {
...
static void unpackL2I(UINT8* out, const UINT8* in, int pixels) {
...
static void unpackL2R(UINT8* out, const UINT8* in, int pixels) {
...
static void unpackL2IR(UINT8* out, const UINT8* in, int pixels) {
...
static void unpackL4(UINT8* out, const UINT8* in, int pixels) {
    /* nibbles (msb first, white is non-zero) */
    while (pixels > 0) {
        UINT8 byte = *in++;
        switch (pixels) {
...
static void unpackL4I(UINT8* out, const UINT8* in, int pixels) {
    /* nibbles (msb first, white is zero) */
    while (pixels > 0) {
        UINT8 byte = *in++;
        switch (pixels) {
...
static void unpackL4R(UINT8* out, const UINT8* in, int pixels) {
    /* nibbles (bit order reversed, white is non-zero) */
    while (pixels > 0) {
        UINT8 byte = *in++;
        byte = BITFLIP[byte];
...
static void unpackL4IR(UINT8* out, const UINT8* in, int pixels) {
    /* nibbles (bit order reversed, white is zero) */
    while (pixels > 0) {
        UINT8 byte = *in++;
        byte = BITFLIP[byte];
...
static void unpackLA(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackLAL(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* LA, line interleaved */
...
static void unpackLI(UINT8* out, const UINT8* in, int pixels) {
    /* negative */
    int i;
    for (i = 0; i < pixels; i++) out[i] = ~in[i];
}

static void unpackLR(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* RGB, bit reversed */
    for (i = 0; i < pixels; i++) {
        out[i] = BITFLIP[in[i]];
...
static void unpackL16(UINT8* out, const UINT8* in, int pixels) {
...
static void unpackL16B(UINT8* out, const UINT8* in, int pixels) {
    int i;
...
static void unpackP1(UINT8* out, const UINT8* in, int pixels) {
    /* bits */
    while (pixels > 0) {
        UINT8 byte = *in++;
        switch (pixels) {
...
static void unpackP2(UINT8* out, const UINT8* in, int pixels) {
    /* bit pairs */
    while (pixels > 0) {
        UINT8 byte = *in++;
        switch (pixels) {
...
static void unpackP4(UINT8* out, const UINT8* in, int pixels) {
    /* nibbles */
    while (pixels > 0) {
        UINT8 byte = *in++;
        switch (pixels) {
...
static void unpackP2L(UINT8* out, const UINT8* in, int pixels) {
    int i, j, m, s;
    /* bit layers */
    m = 128;
    s = (pixels + 7) / 8;
...
static void unpackP4L(UINT8* out, const UINT8* in, int pixels) {
    int i, j, m, s;
...
void ImagingUnpackRGB(UINT8* _out, const UINT8* in, int pixels) {
    int i = 0;
    /* RGB triplets */
    for (; i < pixels - 1; i++) {
        UINT32 iv;
...
void unpackRGB16L(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
void unpackRGB16B(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBL(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBR(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* RGB, bit reversed */
    for (i = 0; i < pixels; i++) {
        UINT32 iv =
...
void ImagingUnpackBGR(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* RGB, reversed bytes */
    for (i = 0; i < pixels; i++) {
...
void ImagingUnpackRGB15(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackRGBA15(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackBGR15(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackBGRA15(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackRGB16(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackBGR16(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackRGB4B(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
void ImagingUnpackRGBA4B(UINT8* out, const UINT8* in, int pixels) {
    int i, pixel;
...
static void ImagingUnpackBGRX(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void ImagingUnpackXRGB(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* RGB, leading pad */
    for (i = 0; i < pixels; i++) {
...
static void ImagingUnpackXBGR(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBALA(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBALA16B(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBa16L(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBa16B(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBa(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* premultiplied RGBA */
    for (i = 0; i < pixels; i++) {
        int a = in[3];
...
static void unpackRGBaskip1(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBaskip2(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    UINT32* out = (UINT32*)_out;
    /* premultiplied RGBA */
    for (i = 0; i < pixels; i++) {
...
static void unpackBGRa(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* premultiplied BGRA */
    for (i = 0; i < pixels; i++) {
        int a = in[3];
...
static void unpackRGBAI(UINT8* out, const UINT8* in, int pixels) {
    int i;
...
static void unpackRGBAL(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
void unpackRGBA16L(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
void unpackRGBA16B(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
static void unpackARGB(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* RGBA, leading pad */
    for (i = 0; i < pixels; i++) {
...
static void unpackABGR(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    /* RGBA, reversed bytes */
    for (i = 0; i < pixels; i++) {
...
static void unpackCMYKI(UINT8* _out, const UINT8* in, int pixels) {
    int i;
...
*/
void ImagingUnpackLAB(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* LAB triplets */
    for (i = 0; i < pixels; i++) {
        out[0] = in[0];
...
static void unpackI16N_I16B(UINT8* out, const UINT8* in, int pixels) {
    int i;
    UINT8* tmp = (UINT8*)out;
    for (i = 0; i < pixels; i++) {
        C16B;
...
static void unpackI16N_I16(UINT8* out, const UINT8* in, int pixels) {
    int i;
    UINT8* tmp = (UINT8*)out;
    for (i = 0; i < pixels; i++) {
        C16L;
...
static void unpackI12_I16(UINT8* out, const UINT8* in, int pixels) {
...
static void copy1(UINT8* out, const UINT8* in, int pixels) {
    /* L, P */
    memcpy(out, in, pixels);
}

static void copy2(UINT8* out, const UINT8* in, int pixels) {
    /* I;16 */
    memcpy(out, in, pixels * 2);
}

static void copy4(UINT8* out, const UINT8* in, int pixels) {
    /* RGBA, CMYK quadruples */
    memcpy(out, in, 4 * pixels);
}

static void copy4skip1(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    for (i = 0; i < pixels; i++) {
        memcpy(_out, in, 4);
        in += 5;
...
static void copy4skip2(UINT8* _out, const UINT8* in, int pixels) {
    int i;
    for (i = 0; i < pixels; i++) {
        memcpy(_out, in, 4);
        in += 6;
...
static void band0(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* band 0 only */
    for (i = 0; i < pixels; i++) {
        out[0] = in[i];
...
static void band1(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* band 1 only */
    for (i = 0; i < pixels; i++) {
        out[1] = in[i];
...
static void band2(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* band 2 only */
    for (i = 0; i < pixels; i++) {
        out[2] = in[i];
...
static void band3(UINT8* out, const UINT8* in, int pixels) {
    /* band 3 only */
    int i;
    for (i = 0; i < pixels; i++) {
        out[3] = in[i];
...
static void band0I(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* band 0 only */
    for (i = 0; i < pixels; i++) {
        out[0] = ~in[i];
...
static void band1I(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* band 1 only */
    for (i = 0; i < pixels; i++) {
        out[1] = ~in[i];
...
static void band2I(UINT8* out, const UINT8* in, int pixels) {
    int i;
    /* band 2 only */
    for (i = 0; i < pixels; i++) {
        out[2] = ~in[i];
...
static void band3I(UINT8* out, const UINT8* in, int pixels) {
    /* band 3 only */
    int i;
    for (i = 0; i < pixels; i++) {
        out[3] = ~in[i];
...
ImagingShuffler ImagingFindUnpacker(const char* mode, const char* rawmode,
                                    int* bits_out) {
    int i;
    ...
    for (i = 0; unpackers[i].rawmode; i++)
        if (strcmp(unpackers[i].mode, mode) == 0 &&
            ...
            if (bits_out) *bits_out = unpackers[i].bits;
