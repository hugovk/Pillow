...
static int affine_transform(double* xout,
                            double* yout,
                            int x,
                            int y,
                            void* data) {
...
static int perspective_transform(double* xout,
                                 double* yout,
                                 int x,
                                 int y,
                                 void* data) {
...
static int quad_transform(double* xout,
                          double* yout,
                          int x,
                          int y,
                          void* data) {
...
Imaging ImagingGenericTransform(Imaging imOut,
                                Imaging imIn,
                                int x0,
                                int y0,
                                int x1,
...
static Imaging ImagingScaleAffine(Imaging imOut,
                                  Imaging imIn,
                                  int x0,
                                  int y0,
                                  int x1,
...
static inline Imaging affine_fixed(Imaging imOut,
                                   Imaging imIn,
                                   int x0,
                                   int y0,
                                   int x1,
...
Imaging ImagingTransformAffine(Imaging imOut,
                               Imaging imIn,
                               int x0,
                               int y0,
                               int x1,
...
Imaging ImagingTransform(Imaging imOut,
                         Imaging imIn,
                         int method,
                         int x0,
                         int y0,
