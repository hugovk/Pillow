...
Imaging
ImagingGenericTransform(Imaging imOut,
                        Imaging imIn,
                        int x0,
                        int y0,
                        int x1,
...
static Imaging
ImagingScaleAffine(Imaging imOut,
                   Imaging imIn,
                   int x0,
                   int y0,
                   int x1,
...
Imaging
ImagingTransformAffine(Imaging imOut,
                       Imaging imIn,
                       int x0,
                       int y0,
                       int x1,
...
Imaging
ImagingTransform(Imaging imOut,
                 Imaging imIn,
                 int method,
                 int x0,
                 int y0,
