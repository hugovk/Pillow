...
static int _hashtable_insert_node(HashTable*,
                                  HashNode*,
                                  int,
                                  int,
                                  CollisionFunc);
...
static void _hashtable_rehash(HashTable* h,
                              CollisionFunc cf,
                              uint32_t newSize) {
...
static int _hashtable_insert_node(HashTable* h,
                                  HashNode* node,
                                  int resize,
                                  int update,
                                  CollisionFunc cf) {
...
static int _hashtable_insert(HashTable* h,
                             HashKey_t key,
                             HashVal_t val,
                             int resize,
                             int update) {
