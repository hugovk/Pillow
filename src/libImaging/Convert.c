...
static void pa2ycbcr(UINT8* out,
                     const UINT8* in,
                     int xsize,
                     const UINT8* palette) {
    pa2rgb(out, in, xsize, palette);
...
#pragma optimize("", off)
#endif
static Imaging topalette(Imaging imOut,
                         Imaging imIn,
                         const char* mode,
...
static Imaging convert(Imaging imOut,
                       Imaging imIn,
                       const char* mode,
...
Imaging ImagingConvert(Imaging imIn,
                       const char* mode,
                       ImagingPalette palette,
                       int dither) {
...
Imaging ImagingConvertTransparent(Imaging imIn,
                                  const char* mode,
                                  int r,
                                  int g,
                                  int b) {
