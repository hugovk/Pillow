...
#define EXPAND_LINE(type, image, yin, yout)                                                    \
    {                                                                                          \
        ...
        for (x = 0; x < xmargin; x++)                                                          \
            imOut->image[yout][xmargin + imIn->xsize + x] = imIn->image[yin][imIn->xsize - 1]; \
    }
...
#define KERNEL1x3(in0, x, kernel, d) ( \
    _i2f((UINT8)in0[x - d]) * (kernel)[0] + _i2f((UINT8)in0[x]) * (kernel)[1] + _i2f((UINT8)in0[x + d]) * (kernel)[2])
...
#define KERNEL1x5(in0, x, kernel, d) ( \
    _i2f((UINT8)in0[x - d - d]) * (kernel)[0] + _i2f((UINT8)in0[x - d]) * (kernel)[1] + _i2f((UINT8)in0[x]) * (kernel)[2] + _i2f((UINT8)in0[x + d]) * (kernel)[3] + _i2f((UINT8)in0[x + d + d]) * (kernel)[4])
