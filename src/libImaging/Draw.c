...
static inline void line32rgba(Imaging im,
                              int x0,
                              int y0,
                              int x1,
                              int y1,
...
static void draw_horizontal_lines(Imaging im,
                                  int n,
                                  Edge* e,
                                  int ink,
                                  int* x_pos,
 ...
 */
static inline int polygon_generic(Imaging im,
                                  int n,
                                  Edge* e,
                                  int ink,
                                  int eofill,
...
static inline int polygon32rgba(Imaging im,
                                int n,
                                Edge* e,
                                int ink,
                                int eofill) {
...
int ImagingDrawLine(Imaging im,
                    int x0,
                    int y0,
                    int x1,
                    int y1,
...
int ImagingDrawWideLine(Imaging im,
                        int x0,
                        int y0,
                        int x1,
                        int y1,
...
int ImagingDrawRectangle(Imaging im,
                         int x0,
                         int y0,
                         int x1,
                         int y1,
...
int ImagingDrawPolygon(Imaging im,
                       int count,
                       int* xy,
                       const void* ink_,
                       int fill,
...
int ImagingDrawBitmap(Imaging im,
                      int x0,
                      int y0,
                      Imaging bitmap,
                      const void* ink,
...
static void
ellipsePoint(int cx, int cy, int w, int h, float i, int* x, int* y) {
    float i_cos, i_sin;
    float x_f, y_f;
    double modf_int;
...
int ImagingDrawChord(Imaging im,
                     int x0,
                     int y0,
                     int x1,
                     int y1,
...
int ImagingDrawEllipse(Imaging im,
                       int x0,
                       int y0,
                       int x1,
                       int y1,
...
int ImagingDrawPieslice(Imaging im,
                        int x0,
                        int y0,
                        int x1,
                        int y1,
...
int ImagingOutlineCurve(ImagingOutline outline,
                        float x1,
                        float y1,
                        float x2,
                        float y2,
...
int ImagingDrawOutline(Imaging im,
                       ImagingOutline outline,
                       const void* ink_,
                       int fill,
                       int op) {
