...
static ImagingEncoderObject* PyImaging_EncoderNew(int contextsize) {
    ImagingEncoderObject* encoder;
    void* context;

    if (PyType_Ready(&ImagingEncoderType) < 0) return NULL;
...
static void _dealloc(ImagingEncoderObject* encoder) {
    if (encoder->cleanup) encoder->cleanup(&encoder->state);
...
static PyObject* _encode_cleanup(ImagingEncoderObject* encoder,
                                 PyObject* args) {
    int status = 0;
...
static PyObject* _encode(ImagingEncoderObject* encoder, PyObject* args) {
    PyObject* buf;
    PyObject* result;
    int status;
    ...
    if (!PyArg_ParseTuple(args, "|n", &bufsize)) return NULL;
    ...
    if (_PyBytes_Resize(&buf, (status > 0) ? status : 0) < 0) return NULL;
...
static PyObject* _encode_to_pyfd(ImagingEncoderObject* encoder,
                                 PyObject* args) {
    PyObject* result;
    int status;
...
static PyObject* _encode_to_file(ImagingEncoderObject* encoder,
                                 PyObject* args) {
    UINT8* buf;
    int status;
    ...
    if (!PyArg_ParseTuple(args, "n|n", &fh, &bufsize)) return NULL;
...
static PyObject* _setimage(ImagingEncoderObject* encoder, PyObject* args) {
    PyObject* op;
    Imaging im;
...
static PyObject* _setfd(ImagingEncoderObject* encoder, PyObject* args) {
    PyObject* fd;
    ImagingCodecState state;
...
static PyObject* _get_pushes_fd(ImagingEncoderObject* encoder) {
...
int get_packer(ImagingEncoderObject* encoder, const char* mode,
               const char* rawmode) {
    int bits;
...
PyObject* PyImaging_EpsEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
...
PyObject* PyImaging_GifEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
    ...
    if (get_packer(encoder, mode, rawmode) < 0) return NULL;
...
PyObject* PyImaging_PcxEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
...
PyObject* PyImaging_RawEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
...
PyObject* PyImaging_TgaRleEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
    ...
    if (!PyArg_ParseTuple(args, "ss|n", &mode, &rawmode, &ystep)) return NULL;
...
PyObject* PyImaging_XbmEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;

    encoder = PyImaging_EncoderNew(0);
    if (encoder == NULL) return NULL;

    if (get_packer(encoder, "1", "1;R") < 0) return NULL;
...
PyObject* PyImaging_ZipEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
    ...
    if (rawmode[0] == 'P') /* disable filtering */
...
PyObject* PyImaging_LibTiffEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
    ...
    const int core_tags[] = {
        256, 257, 258,   259,   262,   263, 266,   269, 274, 277, 278,
        280, 281, 340,   341,   282,   283, 284,   286, 287, 296, 297,
        321, 338, 32995, 32998, 32996, 339, 32997, 330, 531, 530, 65537};
...
PyObject* PyImaging_JpegEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
...
static void j2k_decode_coord_tuple(PyObject* tuple, int* x, int* y) {
    *x = *y = 0;
...
PyObject* PyImaging_Jpeg2KEncoderNew(PyObject* self, PyObject* args) {
    ImagingEncoderObject* encoder;
