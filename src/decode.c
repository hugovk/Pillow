...
static ImagingDecoderObject* PyImaging_DecoderNew(int contextsize) {
    ImagingDecoderObject* decoder;
    void* context;

    if (PyType_Ready(&ImagingDecoderType) < 0) return NULL;
...
static void _dealloc(ImagingDecoderObject* decoder) {
    if (decoder->cleanup) decoder->cleanup(&decoder->state);
...
static PyObject* _decode(ImagingDecoderObject* decoder, PyObject* args) {
    UINT8* buffer;
    Py_ssize_t bufsize;
    int status;
    ImagingSectionCookie cookie;

    if (!PyArg_ParseTuple(args, "y#", &buffer, &bufsize)) return NULL;
...
static PyObject* _decode_cleanup(ImagingDecoderObject* decoder,
                                 PyObject* args) {
    int status = 0;
...
static PyObject* _setimage(ImagingDecoderObject* decoder, PyObject* args) {
    PyObject* op;
    Imaging im;
    ...
    if (state->bits > 0) {
        ...
        if (!state->buffer) return PyErr_NoMemory();
    }
...
static PyObject* _setfd(ImagingDecoderObject* decoder, PyObject* args) {
    PyObject* fd;
    ImagingCodecState state;
...
static PyObject* _get_pulls_fd(ImagingDecoderObject* decoder) {
...
static struct PyGetSetDef getseters[] = {
    {"pulls_fd", (getter)_get_pulls_fd, NULL,
     "True if this decoder expects to pull from self.fd itself.", NULL},
...
int get_unpacker(ImagingDecoderObject* decoder, const char* mode,
                 const char* rawmode) {
    int bits;
...
PyObject* PyImaging_BitDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_BcnDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
    ...
    int n = 0;
    int ystep = 1;
    if (!PyArg_ParseTuple(args, "s|ii", &mode, &n, &ystep)) return NULL;
...
PyObject* PyImaging_FliDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_GifDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;

    char* mode;
    int bits = 8;
    int interlace = 0;
    if (!PyArg_ParseTuple(args, "s|ii", &mode, &bits, &interlace)) return NULL;
...
PyObject* PyImaging_HexDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
    ...
    if (get_unpacker(decoder, mode, rawmode) < 0) return NULL;
...
PyObject* PyImaging_LibTiffDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
    char* mode;
    char* rawmode;
    char* compname;
...
PyObject* PyImaging_PackbitsDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_PcdDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
    ...
    if (get_unpacker(decoder, "RGB", "YCC;P") < 0) return NULL;
...
PyObject* PyImaging_PcxDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;

    char* mode;
    char* rawmode;
    int stride;
    if (!PyArg_ParseTuple(args, "ssi", &mode, &rawmode, &stride)) return NULL;
...
PyObject* PyImaging_RawDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_SgiRleDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_SunRleDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_TgaRleDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_XbmDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;

    decoder = PyImaging_DecoderNew(0);
    if (decoder == NULL) return NULL;

    if (get_unpacker(decoder, "1", "1;R") < 0) return NULL;
...
PyObject* PyImaging_ZipDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_JpegDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
...
PyObject* PyImaging_Jpeg2KDecoderNew(PyObject* self, PyObject* args) {
    ImagingDecoderObject* decoder;
