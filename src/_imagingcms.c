...
static PyObject* cms_transform_new(cmsHTRANSFORM transform,
                                   char* mode_in,
                                   char* mode_out) {
...
static void pyCMScopyAux(cmsHTRANSFORM hTransform,
                         Imaging imDst,
                         const Imaging imSrc) {
...
static int pyCMSdoTransform(Imaging im,
                            Imaging imOut,
...
static cmsBool _check_intent(int clut,
                             cmsHPROFILE hProfile,
