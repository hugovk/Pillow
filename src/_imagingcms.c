...
_buildTransform(cmsHPROFILE hInputProfile,
...
_calculate_rgb_primaries(CmsProfileObject* self, cmsCIEXYZTRIPLE* result)
{
    ...
    hTransform = cmsCreateTransform(self->profile,
                                    TYPE_RGB_DBL,
                                    hXYZ,
                                    TYPE_XYZ_DBL,
...
{
    PyErr_WarnEx(PyExc_DeprecationWarning,
                 "product_model is deprecated. Use Unicode model instead.",
                 1);
...
cms_profile_getattr_product_copyright(CmsProfileObject* self, void* closure)
{
    PyErr_WarnEx(
        PyExc_DeprecationWarning,
        "product_copyright is deprecated. Use Unicode copyright instead.",
        1);
...
{
    PyErr_WarnEx(PyExc_DeprecationWarning,
                 "pcs is deprecated. Use padded connection_space instead.",
                 1);
...
cms_profile_getattr_creation_date(CmsProfileObject* self, void* closure)
{
    ...
    return PyDateTime_FromDateAndTime(1900 + ct.tm_year,
                                      ct.tm_mon,
                                      ct.tm_mday,
                                      ct.tm_hour,
                                      ct.tm_min,
...
static struct PyGetSetDef cms_profile_getsetters[] = {
    ...
    { "product_manufacturer",
      (getter)cms_profile_getattr_product_manufacturer },
    ...
    { "chromatic_adaptation",
      (getter)cms_profile_getattr_chromatic_adaptation },
