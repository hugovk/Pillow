...
/*
 * The version of webp that ships with (0.1.3) Ubuntu 12.04 doesn't handle
...
setup_module(PyObject *m) {
    ...
    PyDict_SetItemString(d, "webpdecoder_version",
                         PyUnicode_FromString(WebPDecoderVersion_str()));
