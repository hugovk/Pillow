...
def generate(version: str) -> dict:
    ...
    dep_versions = load_dep_versions()
    ...
    native_deps = [
        ...
        },
        {
            ...
            "type": "library",
            "name": "libimagequant",
            "version": dep_versions["libimagequant"],
            "scope": "optional",
        ...
        },
        {
            ...
            "version": dep_versions["jpegturbo"],
